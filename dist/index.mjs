...
import { Loader2, AlertCircle, ChevronDown, ChevronUp, X, Search, Check, User, Minus, Circle, ChevronRight, SlidersHorizontal, ChevronsUpDown, Inbox, ChevronsLeft, ChevronLeft, ChevronsRight, Info, AlertTriangle, CheckCircle2 } from 'lucide-react';
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          loading ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin", "aria-hidden": "true" }) : leftIcon && /* @__PURE__ */ jsx("span", { className: "shrink-0", children: leftIcon }),
          children,
          rightIcon && !loading && /* @__PURE__ */ jsx("span", { className: "shrink-0", children: rightIcon })
        ]
      })
    );
  }
...
var Input = React9.forwardRef(
  (_a, ref) => {
    ...
    const inputId = id != null ? id : React9.useId();
    ...
    return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-1.5", containerClassName), children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: inputWrapperVariants({ size, state }), children: [
        prefix && /* @__PURE__ */ jsx(
          "span",
          {
...
var Select = React9.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-1.5", containerClassName), children: [
          ...
          children: [
            /* @__PURE__ */ jsxs(
              SelectPrimitive.Trigger,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(SelectPrimitive.Value, { placeholder: /* @__PURE__ */ jsx("span", { className: "text-neutral-400", children: placeholder }) }),
                  /* @__PURE__ */ jsx("span", { className: "shrink-0 text-neutral-400", "aria-hidden": "true", children: loading ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : hasError ? /* @__PURE__ */ jsx(AlertCircle, { className: "h-4 w-4 text-red-500" }) : /* @__PURE__ */ jsx(ChevronDown, { className: "h-4 w-4" }) })
                ]
              }
            ),
            /* @__PURE__ */ jsx(SelectPrimitive.Portal, { children: /* @__PURE__ */ jsxs(
              SelectPrimitive.Content,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(SelectPrimitive.ScrollUpButton, { className: "flex cursor-default items-center justify-center py-1 text-neutral-400", children: /* @__PURE__ */ jsx(ChevronUp, { className: "h-4 w-4" }) }),
                  /* @__PURE__ */ jsx(SelectPrimitive.Viewport, { className: "p-1", children: resolvedGroups.map((group, groupIndex) => /* @__PURE__ */ jsxs(React9.Fragment, { children: [
                    groupIndex > 0 && /* @__PURE__ */ jsx(SelectPrimitive.Separator, { className: "-mx-1 my-1 h-px bg-neutral-100" }),
                    /* @__PURE__ */ jsxs(SelectPrimitive.Group, { children: [
                      group.label && /* @__PURE__ */ jsx(SelectPrimitive.Label, { className: "px-2 py-1.5 text-xs font-medium text-neutral-400", children: group.label }),
                  ...
                  /* @__PURE__ */ jsx(SelectPrimitive.ScrollDownButton, { className: "flex cursor-default items-center justify-center py-1 text-neutral-400", children: /* @__PURE__ */ jsx(ChevronDown, { className: "h-4 w-4" }) })
                ]
              }
            ) })
          ]
      ...
      hasError ? /* @__PURE__ */ jsx("p", { id: errorId, role: "alert", className: "text-xs text-red-500", children: errorMessage }) : helperText ? /* @__PURE__ */ jsx("p", { id: helperId, className: "text-xs text-neutral-500", children: helperText }) : null
    ] });
  }
);
...
var SelectItem = React9.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "absolute left-2 flex h-4 w-4 items-center justify-center", children: /* @__PURE__ */ jsx(SelectPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5" }) }) }),
...
var ModalTitle = React9.forwardRef((_a, ref) => {
...
var ModalDescription = React9.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(
        ...
        children: [
          ...
          dismissible && /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx(X, { className: "h-full w-full" })
            }
          )
        ]
      })
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          /* @__PURE__ */ jsx(TabsPrimitive.List, { className: cn(listVariants({ variant })), children: items.map((item) => /* @__PURE__ */ jsxs(
            TabsPrimitive.Trigger,
            {
              ...
              children: [
                item.label,
                item.adornment && /* @__PURE__ */ jsx("span", { className: "ml-0.5", children: item.adornment })
              ]
            },
            item.value
          )) }),
...
var DropdownMenuTrigger = React9.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(
...
var DropdownMenuContent = React9.forwardRef((_a, ref) => {
...
var DropdownMenuItem = React9.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        icon && /* @__PURE__ */ jsx("span", { className: "shrink-0 [&>svg]:h-4 [&>svg]:w-4", "aria-hidden": "true", children: icon }),
        /* @__PURE__ */ jsx("span", { className: "flex-1", children }),
        shortcut && /* @__PURE__ */ jsx("span", { className: "ml-auto text-xs tracking-widest text-neutral-400", children: shortcut })
      ]
    })
  );
});
DropdownMenuItem.displayName = "DropdownMenuItem";
var DropdownMenuCheckboxItem = React9.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "absolute left-2 flex h-4 w-4 items-center justify-center", children: /* @__PURE__ */ jsx(DropdownMenuPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5" }) }) }),
        children
      ]
    })
  );
...
var DropdownMenuRadioItem = React9.forwardRef((_a, ref) => {
  var _b = _a, { className, children } = _b, props = __objRest(_b, ["className", "children"]);
  return /* @__PURE__ */ jsxs(
...
var DropdownMenuLabel = React9.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(
...
var DropdownMenuSeparator = React9.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(
...
var DropdownMenuSubTrigger = React9.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        icon && /* @__PURE__ */ jsx("span", { className: "shrink-0 [&>svg]:h-4 [&>svg]:w-4", "aria-hidden": "true", children: icon }),
        /* @__PURE__ */ jsx("span", { className: "flex-1", children }),
        /* @__PURE__ */ jsx(ChevronRight, { className: "ml-auto h-4 w-4 text-neutral-400", "aria-hidden": "true" })
      ]
    })
  );
});
DropdownMenuSubTrigger.displayName = "DropdownMenuSubTrigger";
var DropdownMenuSubContent = React9.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(DropdownMenuPrimitive.Portal, { children: /* @__PURE__ */ jsx(
...
var ToggleGroup = React9.forwardRef((_a, ref) => {
...
var Combobox = React9.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-1.5", containerClassName), children: [
      ...
      /* @__PURE__ */ jsxs(PopoverPrimitive.Root, { open, onOpenChange: isDisabled ? void 0 : setOpen, children: [
        /* @__PURE__ */ jsx(PopoverPrimitive.Trigger, { asChild: true, children: /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("span", { className: "flex shrink-0 items-center gap-1 text-neutral-400", children: [
                selected.length > 0 && !loading && /* @__PURE__ */ jsx(
                  "span",
                  {
                    role: "button",
                ...
                loading ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : hasError ? /* @__PURE__ */ jsx(AlertCircle, { className: "h-4 w-4 text-red-500" }) : /* @__PURE__ */ jsx(
                  ChevronDown,
                  {
                    className: cn(
        ...
        /* @__PURE__ */ jsx(PopoverPrimitive.Portal, { children: /* @__PURE__ */ jsxs(
          PopoverPrimitive.Content,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-neutral-200 px-3 py-2", children: [
                /* @__PURE__ */ jsx(Search, { className: "h-3.5 w-3.5 shrink-0 text-neutral-400", "aria-hidden": true }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    ref: searchRef,
              ...
              /* @__PURE__ */ jsx(
                "ul",
                {
                  ...
                  children: filtered.length === 0 ? /* @__PURE__ */ jsx("li", { className: "px-3 py-6 text-center text-sm text-neutral-400", children: emptyMessage }) : filtered.map((group, gi) => /* @__PURE__ */ jsxs(React9.Fragment, { children: [
                    gi > 0 && /* @__PURE__ */ jsx(
                      "li",
                      {
                        role: "separator",
                          ...
                          children: [
                            /* @__PURE__ */ jsx(
                              "span",
                              {
                                ...
                                "aria-hidden": true,
                                children: checked && /* @__PURE__ */ jsx(Check, { className: "h-3 w-3" })
                              }
                            ),
                            /* @__PURE__ */ jsx("span", { className: "flex-1 truncate", children: option.label }),
                            option.adornment && /* @__PURE__ */ jsx("span", { className: "ml-auto shrink-0", children: option.adornment })
                          ]
                        },
                        option.value
                      );
              ...
              multiple && selected.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-neutral-200 px-3 py-2", children: [
...
var variantIcon = {
  default: null,
  success: /* @__PURE__ */ jsx(CheckCircle2, { className: "h-5 w-5 text-emerald-500" }),
  warning: /* @__PURE__ */ jsx(AlertTriangle, { className: "h-5 w-5 text-amber-500" }),
  destructive: /* @__PURE__ */ jsx(AlertCircle, { className: "h-5 w-5 text-red-500" }),
  info: /* @__PURE__ */ jsx(Info, { className: "h-5 w-5 text-blue-500" })
};
var positionStyles = {
...
var ToastProvider = ({
  ...
  const dismissAll = React9.useCallback(() => setToasts([]), []);
  return /* @__PURE__ */ jsx(ToastContext.Provider, { value: { toasts, toast, dismiss, dismissAll }, children: /* @__PURE__ */ jsxs(ToastPrimitive.Provider, { swipeDirection: "right", children: [
    children,
    /* @__PURE__ */ jsx(
    ...
    toasts.map((t) => /* @__PURE__ */ jsx(ToastItem, { data: t, onDismiss: () => dismiss(t.id) }, t.id))
  ] }) });
};
var ToastItem = ({ data, onDismiss }) => {
  const { id, variant = "default", title, description, action, duration = 5e3, loading } = data;
  const icon = loading ? /* @__PURE__ */ jsx(Loader2, { className: "h-5 w-5 animate-spin text-neutral-400" }) : variantIcon[variant];
  return /* @__PURE__ */ jsxs(
    ToastPrimitive.Root,
    {
      ...
      children: [
        icon && /* @__PURE__ */ jsx("span", { className: "mt-0.5 shrink-0", "aria-hidden": "true", children: icon }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col gap-1 min-w-0", children: [
          /* @__PURE__ */ jsx(ToastPrimitive.Title, { className: "text-sm font-semibold text-neutral-900 leading-snug", children: title }),
          description && /* @__PURE__ */ jsx(ToastPrimitive.Description, { className: "text-xs text-neutral-500 leading-snug", children: description }),
          action && /* @__PURE__ */ jsx(
...
var SkeletonText = (_a) => {
  ...
  return /* @__PURE__ */ jsx(
    ...
    __spreadProps(__spreadValues({
      ...
      children: Array.from({ length: lines }).map((_, i) => /* @__PURE__ */ jsx(
        Skeleton,
        {
          variant: "line",
          className: cn(
  ...
  return /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex flex-1 flex-col gap-2", children: Array.from({ length: lines }).map((_, i) => /* @__PURE__ */ jsx(
          Skeleton,
          {
            variant: "line",
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 p-4", children: [
          /* @__PURE__ */ jsx(Skeleton, { variant: "line", className: "h-5 w-3/4" }),
          /* @__PURE__ */ jsx(SkeletonText, { lines, shortenLast: true })
        ] })
      ]
    })
  );
...
var SkeletonTable = (_a) => {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        header && /* @__PURE__ */ jsx("div", { className: "flex border-b border-neutral-200 bg-neutral-50", children: Array.from({ length: columns }).map((_, col) => /* @__PURE__ */ jsx("div", { className: "flex-1 px-4 py-3", children: /* @__PURE__ */ jsx(Skeleton, { className: cn("h-3.5", headerWidth(col)) }) }, col)) }),
        Array.from({ length: rows }).map((_, row) => /* @__PURE__ */ jsx(
          "div",
          {
            className: "flex border-b border-neutral-100 last:border-0",
            children: Array.from({ length: columns }).map((_2, col) => /* @__PURE__ */ jsx("div", { className: "flex-1 px-4 py-3", children: /* @__PURE__ */ jsx(Skeleton, { className: cn("h-3.5", colWidth(col)) }) }, col))
          },
          row
        ))
      ]
...
var AvatarGroup = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        visible.map((item, i) => /* @__PURE__ */ jsx(
          Avatar,
...
var CardBody = React9.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(
    "div",
    __spreadValues({
...
var CardImage = React9.forwardRef(
  (_a, ref) => {
    var _b = _a, {
      className,
      src,
...
var Checkbox = React9.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "relative flex h-4 w-4 cursor-pointer items-center justify-center", children: [
      /* @__PURE__ */ jsx(
        "input",
        __spreadValues({
          type: "checkbox",
      ...
      /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: indeterminate ? /* @__PURE__ */ jsx(Minus, { className: "h-2.5 w-2.5 text-white" }) : /* @__PURE__ */ jsx(Check, { className: "h-2.5 w-2.5 text-white opacity-0 transition-opacity duration-100" })
        }
      )
    ] });
  }
...
function DataTable({
  ...
  const [page, setPage] = React9.useState(1);
  const [pageSize, setPageSize] = React9.useState(
  ...
  const visibleColumns = React9.useMemo(
  ...
  const paginated = React9.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex flex-col gap-3", className), children: [
    toolbar && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-1 items-center gap-2", children: [
        /* @__PURE__ */ jsx("div", { className: "relative w-64", children: /* @__PURE__ */ jsx(
          Input,
          {
            placeholder: "Search\u2026",
            value: search,
            onChange: (e) => setSearch(e.target.value),
            prefix: /* @__PURE__ */ jsx(Search, { className: "h-3.5 w-3.5" }),
            suffix: search ? /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
                onClick: () => setSearch(""),
        ...
        selectable && selected.size > 0 && /* @__PURE__ */ jsxs(Badge, { variant: "secondary", size: "sm", children: [
          selected.size,
          " selected"
        ] })
      ] }),
      /* @__PURE__ */ jsxs(DropdownMenu, { children: [
        /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsx(
          Button,
          {
            variant: "outline",
            size: "sm",
            leftIcon: /* @__PURE__ */ jsx(SlidersHorizontal, { className: "h-3.5 w-3.5" }),
            children: "Columns"
          }
        ) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-md border-[1.5px] border-neutral-200", children: loading ? /* @__PURE__ */ jsx(
      SkeletonTable,
      {
      ...
      /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-neutral-200 bg-neutral-50", children: [
        selectable && /* @__PURE__ */ jsx("th", { className: "w-10 px-4 py-3", children: /* @__PURE__ */ jsx(
          Checkbox,
          {
            checked: allChecked,
            ...
            "th",
            {
              ...
              children: /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    col.header,
                    col.sortable && /* @__PURE__ */ jsx("span", { className: "shrink-0 text-neutral-300", "aria-hidden": true, children: sortKey === col.key ? sortDir === "asc" ? /* @__PURE__ */ jsx(ChevronUp, { className: "h-3.5 w-3.5 text-neutral-700" }) : /* @__PURE__ */ jsx(ChevronDown, { className: "h-3.5 w-3.5 text-neutral-700" }) : /* @__PURE__ */ jsx(ChevronsUpDown, { className: "h-3.5 w-3.5" }) })
                  ]
                }
              )
            },
        ...
        rowActions && /* @__PURE__ */ jsx("th", { className: "w-10 px-4 py-3" })
      ] }) }),
      /* @__PURE__ */ jsx("tbody", { children: paginated.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx(
        "td",
        {
          colSpan: visibleColumns.length + (selectable ? 1 : 0) + (rowActions ? 1 : 0),
          children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-2 px-4 py-12 text-center", children: [
            /* @__PURE__ */ jsx(Inbox, { className: "h-8 w-8 text-neutral-300", "aria-hidden": true }),
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-neutral-700", children: emptyMessage }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-neutral-400", children: search ? `No results for "${search}"` : emptyDescription }),
            search && /* @__PURE__ */ jsx(
              Button,
              {
                size: "sm",
    ...
    hasPagination && !loading && sorted.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsx("p", { className: "text-xs text-neutral-500 shrink-0", children: selected.size > 0 ? `${selected.size} of ${sorted.length} selected` : `${sorted.length} result${sorted.length !== 1 ? "s" : ""}` }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xs text-neutral-500 shrink-0", children: "Rows" }),
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1", children: pageSizeOptions.map((n) => /* @__PURE__ */ jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
          ...
          /* @__PURE__ */ jsxs("span", { className: "min-w-[5rem] text-center text-xs text-neutral-600", children: [
            currentPage,
            " / ",
            totalPages
          ] }),
...
export { Avatar, AvatarGroup, Badge, Button, Card, CardBody, CardDescription, CardFooter, CardHeader, CardImage, CardTitle, Checkbox, Combobox, DataTable, DropdownMenu, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem, DropdownMenuLabel, DropdownMenuPortal, DropdownMenuRadioGroup, DropdownMenuRadioItem, DropdownMenuSeparator, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger, DropdownMenuTrigger, Input, Modal, ModalBody, ModalClose, ModalDescription, ModalFooter, ModalHeader, ModalTitle, Select, SelectItem, Skeleton, SkeletonAvatar, SkeletonButton, SkeletonCard, SkeletonTable, SkeletonText, Tabs, TabsContent, TabsList, TabsRoot, TabsTrigger, ToastProvider, Toggle, ToggleGroup, ToggleGroupItem, Tooltip, TooltipProvider, badgeVariants, buttonVariants, triggerVariants2 as tabsTriggerVariants, toggleVariants, useToast };
